...
def main():
    ...
    recipe_file = 'colonMedia.csv'  # Replace with your actual recipe file
    ...
    # Read the recipe from the CSV file
    recipe = helper.read_recipe(recipe_file)

    # Generate the recipe
    recipe_output = helper.generate_recipe(recipe)
